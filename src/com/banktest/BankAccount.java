...
class Account {
    public static void main(String[] args) {
        ...
        SavingsAccount sac = new SavingsAccount(1001, "Ann Kamau", "0720000", "test@gmail.com", 1000);
        sac.accountholder();
        sac.deposit(500);
        sac.displayBalance();

        System.out.println("\nCURRENT ACCOUNT DETAILS");
        CurrentAccount cac = new CurrentAccount(1002, "Isaac Datch", "07202020", "isaac@yahoo.com", 10);
        cac.accountholder();
        cac.deposit(300);
        cac.displayBalance();
    }
